...
| OP-010 | MUST | W | Apply rate limits and communicate them via `RateLimit` and `RateLimit-Policy`. | T4, T5 | [draft-11](https://datatracker.ietf.org/doc/draft-ietf-httpapi-ratelimit-headers/) | Moderate — **active draft, zero vendor adoption** |
