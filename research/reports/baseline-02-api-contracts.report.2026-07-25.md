...
| --- | --- | --- | --- | --- | --- | --- |
| AC-001 | MUST | Publish an OpenAPI 3.2.0 document as the contract source of truth; validate payload structure with JSON Schema 2020-12. | Machine-checkable contract; 3.2 aligns with 2020-12. | Accept 3.1 input documents. | [OAS](https://spec.openapis.org/oas/latest.html), [JSON Schema](https://json-schema.org/specification) | High |
