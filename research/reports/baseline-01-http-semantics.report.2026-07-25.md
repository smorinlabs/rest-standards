...
| HS-009 | MAY | Use QUERY (RFC 10008) for safe, idempotent, body-carrying reads instead of overloading POST. | Closes the GET/POST gap; safe, idempotent, and cacheable with a body. | **Deliberately MAY, not SHOULD** — three months old, no surveyed vendor has shipped it, intermediary support unproven. Revisit at next research cycle. | [10008](https://datatracker.ietf.org/doc/rfc10008/) | Moderate |
