...
| Normative standard | Stable rules and rationale | Phase 3 | **In progress 2026-08-09** — `rest-api-standard.md` created: rule-ID mapping policy (R-numbers; `HS-*`/`AC-*`/`OP-*` frozen as provenance keys), §1 purpose/terminology/conformance (tiers, switches, no-silent-deviation, conformance-note template), reserved-name inventory (§1.10). §2–§12 pending |
