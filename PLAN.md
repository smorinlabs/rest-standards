...
| Normative standard | Stable rules and rationale | Phase 3 | **Phase 3 drafting complete 2026-08-09, pending Gate D** — `rest-api-standard.md`: §1–§12 (124 rules with provenance, classification, confidence; unratified apparatus marked "Apparatus (Gate D)"), Part II Decision Log (provenance map + 18-item apparatus register as the Gate D walk list), Appendices A–G, Spectral fixture draft (`conformance/spectral.yaml`, execution-verified at Phase 4) |
